...
tooltip, Made By Owner fisch, %TooltipX%, %Tooltip1%, 1
tooltip, Runtime: 0h 0m 0s, %TooltipX%, %Tooltip2%, 2

tooltip, Press "P" to SLEEP, %TooltipX%, %Tooltip4%, 4
tooltip, Press "O" to WAKE UP, %TooltipX%, %Tooltip5%, 5
tooltip, Press "M" to GET OUT, %TooltipX%, %Tooltip6%, 6
